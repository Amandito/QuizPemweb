...
<h1 class="font-bold text-2xl mb-5">Product Detail</h1>
  ...
  <a href="{{route('product.index')}}" class="focus:outline-none text-white bg-red-400 hover:bg-red-500 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-red-900">Back</a>
@endsection